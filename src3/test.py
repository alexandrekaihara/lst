...
c1.setDefaultGateway('192.168.56.0', 24, s1)
...
h1.setDefaultGateway('192.168.56.1', 24, s1)

h2.connect(s1)
h2.setIp('192.168.100.1', 24)
h2._Node__addRoute('192.168.56.0', 24, s1)
h2.setDefaultGateway('192.168.56.1', 24, s1)
