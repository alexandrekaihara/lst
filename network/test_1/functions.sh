...
# Brief: Move all generated configuration files to the linuxclients containers
# Params:
#   - $1: name of the container
#   - $2: subnet of the container
#   - $3: name of the client behaviour file
# Example:
#   - move_configs mailserver 200 attacker
move_configs(){
